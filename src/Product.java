...
//        if(this.title.equals(otherProduct.title) && this.artist.equals(otherProduct.artist)) {
//        	return 0;
//        }else if(this.title.equals(otherProduct.title)) {
//        	if(this.artist.compareTo(otherProduct.artist) < 0) {
//        		return -1;
//        	}else {
//        		return 1;
//        	}
//        }else {
//        	if(this.title.compareTo(otherProduct.title) < 0) {
//        		return -1;
//        	}else {
//        		return 1;
//        	}
